...
@CucumberOptions(publish = true,plugin = { "pretty", "html:target/site/cucumber-pretty", "rerun:target/rerun.txt",
		...
		features = { "src/test/resources/Features/SwagLogin.feature",
							"src/test/resources/Features/SwagLogout.feature" }, 
...
public class SwagRunnerForAllFeature extends AbstractTestNGCucumberTests {
